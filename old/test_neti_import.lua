--------------------------------------------------------------------------------------
-- This script will create a .ugx file from a small NeuGen-generated neural network	--
...
if not subsetsByLayer then
	neededSubsets = {"Axon", "Dendrite", "Soma", "PreSynapseEdges", "PostSynapseEdges", "PreSynapse"}
else
	neededSubsets = {"AXON__L4_STELLATE", "AXON__L23_PYRAMIDAL", "AXON__L5A_PYRAMIDAL", "AXON__L5B_PYRAMIDAL",
					 ...
					 "PreSynapseEdges", "PostSynapseEdges", "PreSynapse"}
end
