...
dev_start = util.GetParamNumber("-devStart", 0.005)
...
-- file handling
outPath = util.GetParam("-outName", "sol_new_clearance_1e-3")
outPath = outPath .. "/"
...
-- cable equation
CE = CableEquation("soma, axon, " .. dendSubsets, false)
