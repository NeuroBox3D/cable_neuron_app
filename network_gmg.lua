...
nCoarseProcs= util.GetParamNumber("-cProcs",		256,	"#procs for coarse level")
...
balancer.firstDistProcs			= nCoarseProcs
...
-- GMG --
-- base solver --
baseConvCheck = CompositeConvCheck3dCPU1(approxSpace, 20, 1e-40, 1e-12)
baseConvCheck:set_component_check("v", 1e-28, 1e-12)
baseConvCheck:set_level(0)
baseConvCheck:set_verbose(verbose)
...
-- linear solver --
linConvCheck = CompositeConvCheck3dCPU1(approxSpace, 20, 1e-40, 1e-12)
linConvCheck:set_component_check("v", 1e-28, 1e-12)
