...
-------------------------------------------------------------- 
-- NOTE: you need a subdirectory "meas" in your outputPath
measFileVm = outputPath.."meas/measVm.txt"
measFileCa = outputPath.."meas/measCa.txt"
...
--------------------------------------------------------------------------------
dom = Domain()
LoadDomain(dom, gridName) -- means: load on every proc
...
-- calibrate leak to eliminate net calcium flux in equilibrium
...
-- delete geom files
--os.remove("../apps/cable/Ca_dyms/grids/13-L3pyr-77.CNG_syn.ugx")
