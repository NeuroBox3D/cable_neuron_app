...
--------------------------------------------------------------------------------
-- constants
InfluxValue = {1e-1} -- in C/m^2/ms
--(4.09897e-06, -7.83906e-08, 1.11741e-06)
--influx for 4 refines
InfluxPlacex = {1.6e-05} --{-2.0e-5}-- in m 
...
it = 0
-- Point of Output
--0.000108177, 7.61766e-05, 0
xStelle = 0.000108177--0.00035087
yStelle = 7.61766e-05---0.000130453
zStelle = 0.0--7.6404e-05


-- choose algebra
InitUG(dim, AlgebraType("CPU", 1));

if 	dim == 3 then gridName = util.GetParam("-grid", "Rallpack.ugx")
end
